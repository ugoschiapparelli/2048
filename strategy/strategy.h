...
/**
 *\brief IA rapide pour essayer de finir le jeu 
 *\return stratégie à utiliser
 */

extern strategy A1_bedin_etcheverry_schiapparelli_fast();

/**
 *\brief IA lente pour essayer de finir le jeu avec un meilleur score 
 *\return stratégie à utiliser
 */

extern strategy A1_bedin_etcheverry_schiapparelli_efficient();
